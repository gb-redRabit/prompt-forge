  ...
  <section class="relative py-0 md:py-8 lg:py-12 xl:py-20">
    ...
    <div class="relative">
      ...
      <div class="text-center mb-3 md:mb-6 lg:mb-8 xl:mb-12">
        ...
        <h2
          v-once
          class="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold bg-gradient-to-r from-slate-900 via-primary-600 to-purple-600 dark:from-white dark:via-primary-400 dark:to-purple-400 bg-clip-text text-transparent mb-2 md:mb-3 lg:mb-4"
        >
          {{ $t("app.demo.title") }}
        </h2>
        <p
          v-once
          class="text-sm md:text-base lg:text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto hidden md:block"
        >
          {{ $t("app.demo.subtitle") }}
        </p>
      </div>
